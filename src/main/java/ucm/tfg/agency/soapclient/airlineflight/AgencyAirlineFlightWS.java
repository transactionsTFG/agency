...
public interface AgencyAirlineFlightWS {
    ...
    public FlightSOAP search(
            @WebParam(name = "idFlightSearch", targetNamespace = "") long idFlightSearch);
    ...
    public FlightInstanceDTO searchFlightInstance(
            @WebParam(name = "idFlightInstance", targetNamespace = "") long idFlightInstance);
     ...
     * @return
     *         returns
     *         java.util.List<ucm.tfg.agency.soapclient.airlineflight.IdFlightInstanceWithSeatsDTO>
     */
    @WebMethod
    @WebResult(targetNamespace = "")
    ...
    public List<IdFlightInstanceWithSeatsDTO> searchFlightInstanceByReservation(
            @WebParam(name = "reservationId", targetNamespace = "") long reservationId);
     ...
     * @return
     *         returns
     *         java.util.List<ucm.tfg.agency.soapclient.airlineflight.FlightListDTO>
     */
    @WebMethod
    @WebResult(targetNamespace = "")
    ...
    public List<FlightListDTO> searchFlight(
            @WebParam(name = "paramSearchFlight", targetNamespace = "") ParamSearchFlightSOAP paramSearchFlight);
