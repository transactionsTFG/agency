...
/**
 * <p>Clase Java para idFlightInstanceWithSeatsSOAP complex type.
 * 
 * <p>El siguiente fragmento de esquema especifica el contenido que se espera que haya en esta clase.
 * 
 * <pre>
 * &lt;complexType name="idFlightInstanceWithSeatsSOAP"&gt;
 *   &lt;complexContent&gt;
...
@XmlType(name = "idFlightInstanceWithSeatsSOAP", propOrder = {
    "idFlightInstance",
    "seats"
})
