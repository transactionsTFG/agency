 ...
 * 
 */
@WebServiceClient(name = "ReservationWS", targetNamespace = "http://soap/", wsdlLocation = "http://localhost:8080/airlineMTA/ReservationWS?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://localhost:8080/airlineMTA/ReservationWS?wsdl");
